...
local LOOKUP_TABLE_URL = "https://raw.githubusercontent.com/Cynosphere/emojis.json/master/emojis.json"
local lookup = {}
...
local function get_twemoji_url(name)
	return "https://twemoji.maxcdn.com/v/latest/72x72/" .. lookup[name] .. ".png"
end
