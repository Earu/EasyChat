...
function GAMEMODE:PlayerStartVoice(ply)
	if EC_VOICE_HUD:GetBool() and hook.Run("ECVoiceHUD",true) ~= false and engine.ActiveGamemode() ~= "terrortown" then
...
function GAMEMODE:PlayerEndVoice(ply)
	if EC_VOICE_HUD:GetBool() and hook.Run("ECVoiceHUD",false) ~= false and engine.ActiveGamemode() ~= "terrortown" then
